var what_i_do_array = ["Agile project management", "Photography", "Print design", "Editing", "Illustration", "Having great opinions", "Owning many grey markers", "Event management", "Diversity consulting", "Intellectual labour", "Emotional labour", "I also make great coffee", "Teaching technology", "Telling computers what to do"]
var talk_to_me_if_array = ["You frequently preface sentences with the phrase 'this might sound crazy, but hear me out'.", "You have a terrible idea.", "You have a great idea.", "You need lean and practical UX advice.", "You just don't know where to use apostrophes and would pay for me to tell you when you are using apostrophes incorrectly.", "You like the cut of my jib.", "You want to talk through and plan a website or app.", "You want to build a small website quickly.", "You are doing interesting work.", "You are doing work that makes the world a little better."]
